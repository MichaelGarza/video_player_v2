    ...
    $.fn.videoPlayer = function(options) { // videoPlayer is the name of our plugin
            ...
            $( '<div class="player">'
                 ...
                 + '<div class="controls-left">'
                   + '<div class="play-pause play">'
                     + '<span class="play-button"><img src="icons/play-icon.png"></span>'
        ...
        $spc.addEventListener('timeupdate', timeUpdate);
            ...
            $('body, html').bind('mousemove', function(e) {
                ...
                if($begin == true) {
 //                   $that.hover(function() {
 //                       $that.find('.play-pause, .time, .volume, .fullscreen').stop(true, false).animate({'opacity' : '1'}, 0.5);
 //                   }, function() {
 //                       $that.find('.play-pause, .time, .volume, .fullscreen').stop(true, false).animate({'opacity' : '0'}, 0.5);
 //                   });
 //                   $that.hover(function() {
 //                       $that.find('.player').stop(true, false).animate({'height' : 100});    
//                    }, function() {
//                        $that.find('.player').stop(true, false).animate({'height' : 100});    
//                    });
                }
